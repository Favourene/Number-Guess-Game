...
function init(){
    guesswork = Math.floor(Math.random() * 100 +1);// this is the math work that gives out the random number, the Math.floor allows the generated number to be an whole number
